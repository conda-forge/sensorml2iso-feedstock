About sensorml2iso-feedstock
============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sensorml2iso-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5811&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sensorml2iso-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sensorml2iso` can be installed with `conda`:
...
```
mamba install sensorml2iso
```

It is possible to list all of the versions of `sensorml2iso` available on your platform with `conda`:
...
```
mamba search sensorml2iso --channel conda-forge
```
...
mamba repoquery search sensorml2iso --channel conda-forge

# List packages depending on `sensorml2iso`:
mamba repoquery whoneeds sensorml2iso --channel conda-forge

# List dependencies of `sensorml2iso`:
mamba repoquery depends sensorml2iso --channel conda-forge
```
...
* [@mwengren](https://github.com/mwengren/)
